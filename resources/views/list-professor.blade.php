        ...
        <div id="line-one">   
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>PROFESSORES CADASTRADOS ({{$total}})</b></h4>
                        <br>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="center">{{$professor->id}}</td>
                                        <td title="Nome">{{$professor->nome}}</td>
                                        <td title="Data de Nascimento">{{$professor->data_nascimento}}</td>
