        ...
        <div id="line-one">   
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>CURSOS CADASTRADOS ({{$total}})</b></h4>
                        <br>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nome</th>
                                        <th id="center">Professor</th>                 
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($curso as $curso)
                                    <tr>
                                        <td id="center">{{$curso->id}}</td>
                                        <td title="Nome">{{$curso->nome}}</td>
                                        <td title="Professor" id="center">{{$curso->professor_id}}</td>
                                        <td id="center">
                                            </td>
                                        <td id="center">
